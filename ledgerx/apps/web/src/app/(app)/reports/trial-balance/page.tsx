        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-200 dark:border-navy-100/20 bg-slate-100 dark:bg-navy-100/20">
              <th className="px-4 py-3 text-left text-slate-500 dark:text-slate-400">Ledger</th>
              <th className="px-4 py-3 text-left text-slate-500 dark:text-slate-400">Group</th>
          ...
          <tbody>
            {rows.map((r, i) => (
              <tr key={i} className="border-b border-slate-200 dark:border-navy-100/10">
                ...
                <td className="px-4 py-2 text-slate-500 dark:text-slate-400">{r.group_name}</td>
          ...
          <tfoot>
            <tr className="border-t border-gold/30 bg-slate-100 dark:bg-navy-100/20 font-medium">
