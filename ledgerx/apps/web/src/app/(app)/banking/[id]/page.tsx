...
export default function BankingReconcilePage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-white">Bank Ledger & Reconciliation</h1>
      <p className="text-slate-400">Left: Our books. Right: Bank statement. Auto-match (green), manual match, BRS summary. Connect to banking API.</p>
