        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-200 dark:border-navy-100/20 bg-slate-100 dark:bg-navy-100/20">
              ...
              <th className="px-4 py-3 text-right text-slate-500 dark:text-slate-400">Taxable</th>
              <th className="px-4 py-3 text-right text-slate-500 dark:text-slate-400">GST</th>
              <th className="px-4 py-3 text-right text-slate-500 dark:text-slate-400">Total</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((r, i) => (
