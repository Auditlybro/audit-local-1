        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-200 dark:border-navy-100/20 bg-slate-100 dark:bg-navy-100/20">
              <th className="px-4 py-3 text-left text-slate-500 dark:text-slate-400">Item</th>
              <th className="px-4 py-3 text-right text-slate-500 dark:text-slate-400">Quantity</th>
              <th className="px-4 py-3 text-right text-slate-500 dark:text-slate-400">Value</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((r, i) => (
