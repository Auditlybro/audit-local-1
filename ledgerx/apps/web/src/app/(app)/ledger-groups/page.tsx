  ...
  return (
    <div className="select-none">
      <div
        ...
        className="flex items-center gap-2 py-2 px-2 rounded hover:bg-navy-100/20"
      >
...
export default function LedgerGroupsPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold text-white">Ledger Groups</h1>
      <p className="text-slate-400 text-sm">28 Tally-compatible groups + custom. Tree view.</p>
