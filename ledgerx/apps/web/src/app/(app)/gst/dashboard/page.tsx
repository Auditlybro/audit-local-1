...
export default function GstDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-white">GST Dashboard</h1>
      <p className="text-slate-400">Filing calendar, status per return. Connect to GST API.</p>
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-navy-100/20 bg-navy-400/80 p-6">
          <Calendar className="h-10 w-10 text-gold mb-2" />
          <h2 className="font-semibold text-white">Filing calendar</h2>
          <p className="mt-2 text-sm text-slate-500">GSTR-1, GSTR-3B due dates by period</p>
        </div>
        <div className="rounded-xl border border-navy-100/20 bg-navy-400/80 p-6">
          <FileCheck className="h-10 w-10 text-gold mb-2" />
          <h2 className="font-semibold text-white">Return status</h2>
